...
use crate::{
    bindings::{gen_napi, gen_typescript, metadata::ModuleMetadata, type_map::TypeMap},
    switches::SwitchArgs,
};

pub(crate) struct NapiBindingGenerator {
    switches: SwitchArgs,
    ts_dir: Utf8PathBuf,
    rust_dir: Utf8PathBuf,
}

impl NapiBindingGenerator {
    ...
    fn generate_ts(
        components: &[Component<NapiConfig>],
        switches: &SwitchArgs,
        out_dir: &Utf8PathBuf,
    ...
    fn generate_rs(
        ...
        for component in components {
            ...
            let rs_code = gen_napi::generate_rs(
                &component.ci,
                &module,
...
impl BindingGenerator for NapiBindingGenerator {
    type Config = NapiConfig;
...
pub(crate) struct NapiConfig {
    ...
    pub(crate) rust: gen_napi::Config,
}
